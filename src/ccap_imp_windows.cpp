...
// Define all required GUIDs locally to avoid strmiids.lib dependency.
// This is a common practice in cross-platform/MinGW builds.
// GUID values are from Windows SDK headers (uuids.h, strmif.h, wmcodecdsp.h, etc.)
...
DEFINE_GUID(MEDIASUBTYPE_NV12,  0x3231564E, 0x0000, 0x0010, 0x80, 0x00, 0x00, 0xaa, 0x00, 0x38, 0x9b, 0x71); // 'NV12'
DEFINE_GUID(MEDIASUBTYPE_I420,  0x30323449, 0x0000, 0x0010, 0x80, 0x00, 0x00, 0xaa, 0x00, 0x38, 0x9b, 0x71); // 'I420'
DEFINE_GUID(MEDIASUBTYPE_IYUV,  0x56555949, 0x0000, 0x0010, 0x80, 0x00, 0x00, 0xaa, 0x00, 0x38, 0x9b, 0x71); // 'IYUV'
DEFINE_GUID(MEDIASUBTYPE_YUY2,  0x32595559, 0x0000, 0x0010, 0x80, 0x00, 0x00, 0xaa, 0x00, 0x38, 0x9b, 0x71); // 'YUY2'
DEFINE_GUID(MEDIASUBTYPE_YV12,  0x32315659, 0x0000, 0x0010, 0x80, 0x00, 0x00, 0xaa, 0x00, 0x38, 0x9b, 0x71); // 'YV12'
DEFINE_GUID(MEDIASUBTYPE_UYVY,  0x59565955, 0x0000, 0x0010, 0x80, 0x00, 0x00, 0xaa, 0x00, 0x38, 0x9b, 0x71); // 'UYVY'
DEFINE_GUID(MEDIASUBTYPE_YUYV,  0x56595559, 0x0000, 0x0010, 0x80, 0x00, 0x00, 0xaa, 0x00, 0x38, 0x9b, 0x71); // 'YUYV'
DEFINE_GUID(MEDIASUBTYPE_YVYU,  0x55595659, 0x0000, 0x0010, 0x80, 0x00, 0x00, 0xaa, 0x00, 0x38, 0x9b, 0x71); // 'YVYU'
DEFINE_GUID(MEDIASUBTYPE_YVU9,  0x39555659, 0x0000, 0x0010, 0x80, 0x00, 0x00, 0xaa, 0x00, 0x38, 0x9b, 0x71); // 'YVU9'
DEFINE_GUID(MEDIASUBTYPE_Y411,  0x31313459, 0x0000, 0x0010, 0x80, 0x00, 0x00, 0xaa, 0x00, 0x38, 0x9b, 0x71); // 'Y411'
DEFINE_GUID(MEDIASUBTYPE_Y41P,  0x50313459, 0x0000, 0x0010, 0x80, 0x00, 0x00, 0xaa, 0x00, 0x38, 0x9b, 0x71); // 'Y41P'
DEFINE_GUID(MEDIASUBTYPE_CLJR,  0x524A4C43, 0x0000, 0x0010, 0x80, 0x00, 0x00, 0xaa, 0x00, 0x38, 0x9b, 0x71); // 'CLJR'
DEFINE_GUID(MEDIASUBTYPE_IF09,  0x39304649, 0x0000, 0x0010, 0x80, 0x00, 0x00, 0xaa, 0x00, 0x38, 0x9b, 0x71); // 'IF09'
DEFINE_GUID(MEDIASUBTYPE_CPLA,  0x414C5043, 0x0000, 0x0010, 0x80, 0x00, 0x00, 0xaa, 0x00, 0x38, 0x9b, 0x71); // 'CPLA'
DEFINE_GUID(MEDIASUBTYPE_AYUV,  0x56555941, 0x0000, 0x0010, 0x80, 0x00, 0x00, 0xaa, 0x00, 0x38, 0x9b, 0x71); // 'AYUV'
DEFINE_GUID(MEDIASUBTYPE_AI44,  0x34344941, 0x0000, 0x0010, 0x80, 0x00, 0x00, 0xaa, 0x00, 0x38, 0x9b, 0x71); // 'AI44'
DEFINE_GUID(MEDIASUBTYPE_IA44,  0x34344149, 0x0000, 0x0010, 0x80, 0x00, 0x00, 0xaa, 0x00, 0x38, 0x9b, 0x71); // 'IA44'
DEFINE_GUID(MEDIASUBTYPE_IMC1,  0x31434D49, 0x0000, 0x0010, 0x80, 0x00, 0x00, 0xaa, 0x00, 0x38, 0x9b, 0x71); // 'IMC1'
DEFINE_GUID(MEDIASUBTYPE_IMC2,  0x32434D49, 0x0000, 0x0010, 0x80, 0x00, 0x00, 0xaa, 0x00, 0x38, 0x9b, 0x71); // 'IMC2'
DEFINE_GUID(MEDIASUBTYPE_IMC3,  0x33434D49, 0x0000, 0x0010, 0x80, 0x00, 0x00, 0xaa, 0x00, 0x38, 0x9b, 0x71); // 'IMC3'
DEFINE_GUID(MEDIASUBTYPE_IMC4,  0x34434D49, 0x0000, 0x0010, 0x80, 0x00, 0x00, 0xaa, 0x00, 0x38, 0x9b, 0x71); // 'IMC4'
