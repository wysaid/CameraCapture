    ...
    for (const auto& size : test_sizes) {
        ...
        AVX2TestRunner::runImageComparisonTest([&]() -> TestImage {
            ...
            ccap::rgbaToBgra(rgba_src.data(), rgba_src.stride(),
                             bgra_dst.data(), bgra_dst.stride(), w, h);
            return bgra_dst;
        ...
        AVX2TestRunner::runImageComparisonTest([&]() -> TestImage {
            ...
            ccap::rgbaToBgr(rgba_src.data(), rgba_src.stride(),
                            bgr_dst.data(), bgr_dst.stride(), w, h);
            return bgr_dst;
...
TEST_F(DualImplementationTest, All_NV12_Conversions_Multiple_Sizes)
{
    ...
    for (const auto& size : test_sizes) {
        ...
        AVX2TestRunner::runImageComparisonTest([&]() -> TestImage {
            ...
            ccap::nv12ToBgra32(y_plane.data(), y_plane.stride(),
                               uv_plane.data(), uv_plane.stride(),
                               bgra_dst.data(), bgra_dst.stride(), w, h,
        ...
        AVX2TestRunner::runImageComparisonTest([&]() -> TestImage {
            ...
            ccap::nv12ToRgba32(y_plane.data(), y_plane.stride(),
                               uv_plane.data(), uv_plane.stride(),
                               rgba_dst.data(), rgba_dst.stride(), w, h,
                               ccap::ConvertFlag::Default);
            return rgba_dst;
        ...
        AVX2TestRunner::runImageComparisonTest([&]() -> TestImage {
            ...
            ccap::nv12ToBgr24(y_plane.data(), y_plane.stride(),
                              uv_plane.data(), uv_plane.stride(),
                              bgr_dst.data(), bgr_dst.stride(), w, h,
                              ccap::ConvertFlag::Default);
            return bgr_dst;
        ...
        AVX2TestRunner::runImageComparisonTest([&]() -> TestImage {
            ...
            ccap::nv12ToRgb24(y_plane.data(), y_plane.stride(),
                              uv_plane.data(), uv_plane.stride(),
                              rgb_dst.data(), rgb_dst.stride(), w, h,
                              ccap::ConvertFlag::Default);
            return rgb_dst;
...
TEST_F(DualImplementationTest, All_I420_Conversions_Multiple_Sizes)
{
    ...
    for (const auto& size : test_sizes) {
        ...
        AVX2TestRunner::runImageComparisonTest([&]() -> TestImage {
            ...
            ccap::i420ToBgra32(y_plane.data(), y_plane.stride(),
        ...
        AVX2TestRunner::runImageComparisonTest([&]() -> TestImage {
            ...
            ccap::i420ToRgba32(y_plane.data(), y_plane.stride(),
                               u_plane.data(), u_plane.stride(),
                               v_plane.data(), v_plane.stride(),
                               rgba_dst.data(), rgba_dst.stride(), w, h,
                               ccap::ConvertFlag::Default);
...
TEST_F(DualImplementationTest, Vertical_Flip_All_Functions)
{
    ...
    AVX2TestRunner::runImageComparisonTest([&]() -> TestImage {
        ...
        ccap::rgbaToBgra(rgba_src.data(), rgba_src.stride(),
                         flipped_dst, -bgra_dst.stride(), w, -h);
        return bgra_dst;
    ...
    AVX2TestRunner::runImageComparisonTest([&]() -> TestImage {
        ...
        ccap::rgbToBgr(rgb_src.data(), rgb_src.stride(),
                       flipped_dst, -bgr_dst.stride(), w, -h);
        return bgr_dst;
...
TEST_F(DualImplementationTest, Solid_Color_YUV_Conversions_Multiple_Sizes)
{
    ...
    for (const auto& size : test_sizes) {
        ...
        auto testSolidColor = [&](const ColorInfo& color, const char* format_name, 
                                  std::function<TestImage()> converter) {
            return AVX2TestRunner::runImageComparisonTest(
                converter,
                std::string(format_name) + " " + color.name + " " + 
                std::to_string(w) + "x" + std::to_string(h) + " dual implementation",
                color.tolerance
            );
        };
...
TEST_F(DualImplementationTest, All_ConvertFlag_Combinations_NV12_Conversions)
{
    ...
    std::vector<FlagCombination> flag_combinations = {
        {ccap::ConvertFlag::BT601 | ccap::ConvertFlag::VideoRange, "BT601_VideoRange", 3},
    ...
    for (const auto& size : test_sizes) {
        ...
        for (const auto& combo : flag_combinations) {
            ...
            AVX2TestRunner::runImageComparisonTest([&]() -> TestImage {
                ...
                ccap::i420ToBgr24(y_plane.data(), y_plane.stride(),
                                  u_plane.data(), u_plane.stride(),
                                  v_plane.data(), v_plane.stride(),
                                  bgr_dst.data(), bgr_dst.stride(), w, h, combo.flag);
                return bgr_dst;
            ...
            AVX2TestRunner::runImageComparisonTest([&]() -> TestImage {
                ...
                ccap::i420ToRgb24(y_plane.data(), y_plane.stride(),
                                  u_plane.data(), u_plane.stride(),
                                  v_plane.data(), v_plane.stride(),
                                  rgb_dst.data(), rgb_dst.stride(), w, h, combo.flag);
                return rgb_dst;
...
TEST_F(DualImplementationTest, Solid_Color_ConvertFlag_Combinations_Extreme_Values)
{
    ...
    std::vector<FlagCombination> flag_combinations = {
        {ccap::ConvertFlag::BT601 | ccap::ConvertFlag::VideoRange, "BT601_VideoRange", 4},
        ...
        for (const auto& color : extreme_colors) {
            ...
            AVX2TestRunner::runImageComparisonTest([&]() -> TestImage {
                ...
                ccap::nv12ToBgra32(yuv_src.y_data(), yuv_src.y_stride(),
                                   ...
                                   test_width, test_height, combo.flag);
                return bgra_dst;
